...
const char *const level_str[] = {"ERROR", "WARN", "INFO", "DEBUG", "TRACE", "MID"};

void log_impl(const char *file, unsigned line, const char *func, unsigned log_level, const char *fmt, ...)
{
    va_list args;
    char mbuf[2048];
    int mlength = 0;
