 ...
 * create server
*/
struct agent_context *create_server(int node_id, int agent_id, struct conn_param *param);
...
int add_connection_rc(struct agent_context *agent,
                      char *dst_addr, char *port,
                      struct conn_param *options);

int add_connection_ud(struct agent_context *agent,
                      char *bind_addr, char *mcast_addr, int is_sender,
                      struct conn_param *options);

int server_listen(struct agent_context *server, char *src_addr, char *port);

int accept_connection(struct agent_context *server,
